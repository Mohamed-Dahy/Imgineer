    ...
    <div className='flex items-center justify-between py-4'>
       ...
       <div>
        ...
        <div className='text-sm sm:text-base lg:text-lg flex items-center gap-4'>          
          <button onClick= {()=>navigate('/buy-credits')} className='flex items-center bg-gray-200 text-gray-800 px-3 py-1 rounded-lg hover:bg-gray-300 transition duration-300 cursor-pointer'>
            <img src={assets.credit_star} alt="" className='w-5 h-5 ml-2' />
            <p className='text-xs sm:text-sm font-medium text-gray-600' >Credits Left : {credit}</p>
          </button>
         <p className='text-sm sm:text-base lg:text-lg'>Welcome, {user.name}!</p>
